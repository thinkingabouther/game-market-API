        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentSessions_Users_ClientID",
                        column: x => x.ClientID,
                        principalTable: "Users",
                        principalColumn: "ID",
            ...
            migrationBuilder.InsertData(
                table: "GameKeys",
                columns: new[] { "ID", "GameID", "IsActivated", "Key"},
                values: new object[] { -1, -1, false, "123456" });

            migrationBuilder.InsertData(
                table: "GameKeys",
                columns: new[] { "ID", "GameID", "IsActivated", "Key"},
                values: new object[] { -2, -2, false, "12345678" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentSessions_ClientID",
